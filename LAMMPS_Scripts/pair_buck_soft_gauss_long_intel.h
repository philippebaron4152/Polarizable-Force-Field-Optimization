...
#ifdef PAIR_CLASS
// clang-format off
PairStyle(buck/soft/gauss/long/intel,PairBuckSoftGaussLongIntel);
// clang-format on
#else

#ifndef LMP_PAIR_BUCK_SOFT_GAUSS_LONG_INTEL_H
#define LMP_PAIR_BUCK_SOFT_GAUSS_LONG_INTEL_H
...
class PairBuckSoftGaussLongIntel : public PairBuckSoftGaussLong {

 public:
  PairBuckSoftGaussLongIntel(class LAMMPS *);
 ...
 private:
  ...
  template <class flt_t> class ForceConst {
   public:
    ...
    typedef struct {
      flt_t a, c, offset, pad, gwidth, lambdas;
    } c_energy_t;
    typedef struct {
      flt_t r, dr, f, df;
    } table_t;
...
#endif    // LMP_PAIR_BUCK_GAUSS_LONG_INTEL_H
#endif
