...
#ifdef PAIR_CLASS
// clang-format off
PairStyle(buck/gauss/long/intel,PairBuckGaussLongIntel);
// clang-format on
#else

#ifndef LMP_PAIR_BUCK_GAUSS_LONG_INTEL_H
#define LMP_PAIR_BUCK_GAUSS_LONG_INTEL_H
...
class PairBuckGaussLongIntel : public PairBuckGaussLong {

 public:
  PairBuckGaussLongIntel(class LAMMPS *);
