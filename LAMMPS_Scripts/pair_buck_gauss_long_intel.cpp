...
#include "pair_buck_gauss_long_intel.h"
...
PairBuckGaussLongIntel::PairBuckGaussLongIntel(LAMMPS *lmp) :
  PairBuckGaussLong(lmp)
{
  suffix_flag |= Suffix::INTEL;
}

void PairBuckGaussLongIntel::compute(int eflag, int vflag)
{
...
void PairBuckGaussLongIntel::eval(const int offload, const int vflag,
                                 IntelBuffers<flt_t,acc_t> *buffers,
                                 const ForceConst<flt_t> &fc,
...
void PairBuckGaussLongIntel::init_style()
{
  PairBuckGaussLong::init_style();
...
template <class flt_t, class acc_t>
void PairBuckGaussLongIntel::pack_force_const(ForceConst<flt_t> &fc,
                                          IntelBuffers<flt_t,acc_t> *buffers)
{
  int off_ccache = 0;
  #ifdef _LMP_INTEL_OFFLOAD
...
void PairBuckGaussLongIntel::ForceConst<flt_t>::set_ntypes(const int ntypes,
                                                           const int ntable,
                                                           Memory *memory,
                                                           const int cop) {
